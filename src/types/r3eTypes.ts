...
export interface IRaceSessionLaps {
	Race1: number;
	Race2: number;
	Race3: number;
}
...
export default interface IShared {
	...
	/** Current Session Length in Minutes/Laps
		Race1, Race2, Race3
		-1 = N/A */
	RaceSessionMinutes: IRaceSessionMinutes;
	RaceSessionLaps: IRaceSessionLaps;
